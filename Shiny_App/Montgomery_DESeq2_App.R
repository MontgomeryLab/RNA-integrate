    ...
    tabsetPanel(type = "tabs",
                ...
                tabPanel("Parameters",
                         ...
                         HTML("<p>Welcome to the Montgomery DESeq2 Graphics and Analysis App, developed by the Montgomery Lab at Colorado State University. 
                              This app uses tabulated counts files from mRNA or small RNA sequencing Differential Gene Expression (DGE) experiments to produce user-friendly results tables and plots. 
                         ...
                         HTML("<p>Enter a brief identifier (no spaces or special characters) for this experimental run (ex. <strong>elegans1</strong>).</p> 
                              <p>The experiment ID will be prepended to file names of saved tables and plots.</p>"),
                         ...
                         HTML("<p>Select the tabulation software used to produce counts files.</p>
                              <p>for FeatureCounts matrices or counts matrices consisting of samples eparated by column, select <strong>Counts Matrix</strong>.</p>
                              <p>If <strong>Counts Matrix</strong> or <strong>tiny RNA</strong> is selected, choose the appropriate matrix file from the working directory.</p>"),
                         br(),
                         ...
                         HTML("<p>Select the appropriate metadata file from the working directory, or choose to generate a new metadata file within the app.</p>
                              <p>To generate a new metadata file, select <strong>generate new</strong> as the metadata method and then follow the prompts that appear.</p>
                              <p>Next, choose the type of gene table (optional) that will be imported for customizing tables and plots.
                              An uploaded gene table csv can include gene IDs and their <strong>Common Names</strong> (public names), <strong>Class Names</strong> (for small RNA or other classifications), or <strong>Both</strong>.</p>"),
                         br(),
                         ...
                         fluidRow(
                           column(6,
                                  ...
                                  # Metadata Method
                                  selectInput("metadata_method", "Use existing csv (from working directory) or generate a new csv",
                         ...
                         HTML("<p>Follow the prompts to customize mean reads scatter plots and/or the heatmap.</p>
                              <p>With a gene table imported, both the mean reads scatter plots and the heatmap can be customized by the classes included in the gene table.</p> 
                              <p>A <strong>class parameters</strong> csv can be imported from the working directory or generated within the app to color or size points by class.</p>
                              <p>Three heatmap types are available if a gene table is imported. See the heatmap tab for more details.</p>"),
                         br(),
                         ...
                         fluidRow(
                           column(7,
                                  ...
                                  # Customize by Significance and Class Parameters Generation Options
