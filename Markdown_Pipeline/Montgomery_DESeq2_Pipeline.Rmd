...
if (params$software_method == "tiny_rna") {tiny_rna_matrix = read.csv(params$counts_matrix)} else {tiny_rna_matrix = NULL}
...
if (params$customize_by_class == FALSE | params$gene_table_method == "no_table" | params$gene_table_method == "common_names_only") {
