...
params:
  ...
  lower_transparency: 0.5
  upper_transparency: 0.9
  customize_by_class: TRUE
  customize_by_significance: TRUE
  class_parameters: ""
  generate_ma: TRUE
...
can be selected from the working directory. If no class parameters csv is selected, every class will be automatically colored from a list of 15 colors,
and every point will be sized with a cex value of 0.3. Insignificant genes will be colored grey if the <strong>customize by significance</strong> feature is set to <strong>TRUE</strong>.
